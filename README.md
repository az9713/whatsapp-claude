...
```
You (iPhone):     /claude use Remotion skills to create a video about bees and owls
...
|---------|-------------|---------|
| **Video Creation** | Generate professional videos with Remotion | `/claude use Remotion skills to create a countdown video` |
...
```
You:     /claude use Remotion skills to create a video about space
...
### Create a Video
```
/claude use Remotion skills to render the CountdownTimer video to output/countdown.mp4
```
...
```
/claude use Remotion skills to create a video about productivity
